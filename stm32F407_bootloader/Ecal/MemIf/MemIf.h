...
extern uint8 MemIf_ReadEE(uint8 Le_u_Object,uint32 Le_dw_Address,uint8* Le_u_Data,uint16 Le_w_Lng);
extern uint8 MemIf_WriteEE(uint8 Le_u_Object,uint32 Le_dw_Address,uint8* Le_u_Data,uint16 Le_w_Lng);
