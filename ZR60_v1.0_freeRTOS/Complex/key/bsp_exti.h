...
#define DOORLOCK_GPIO_CLK                 RCC_AHB1Periph_GPIOA
#define DOORLOCK_GPIO_PIN                 GPIO_Pin_12
...
#define KEY4_INT_GPIO_PORT                GPIOE
#define KEY4_INT_GPIO_CLK                 RCC_AHB1Periph_GPIOE
