...
#define WM8978_I2C_SCL_SOURCE               GPIO_PinSource8
...
#define WM8978_I2C_SDA_SOURCE               GPIO_PinSource9
...
/**
	...
	* WM8978_BCLK   -> PB14/I2S2_CK
	* WM8978_ADCDAT -> PB14/I2S2ext_SD
	* WM8978_DACDAT -> PB15/I2S2_SD
...
#define WM8978_BCLK_GPIO_CLK           RCC_AHB1Periph_GPIOB
#define WM8978_BCLK_PORT            	 GPIOB
#define WM8978_BCLK_PIN             	 GPIO_Pin_13
#define WM8978_BCLK_AF                 GPIO_AF_SPI2
#define WM8978_BCLK_SOURCE             GPIO_PinSource13

#define WM8978_ADCDAT_GPIO_CLK         RCC_AHB1Periph_GPIOB
#define WM8978_ADCDAT_PORT             GPIOB
#define WM8978_ADCDAT_PIN              GPIO_Pin_14
#define WM8978_ADCDAT_AF               GPIO_AF_SPI3    
#define WM8978_ADCDAT_SOURCE           GPIO_PinSource14

#define WM8978_DACDAT_GPIO_CLK         RCC_AHB1Periph_GPIOB
#define WM8978_DACDAT_PORT             GPIOB
#define WM8978_DACDAT_PIN              GPIO_Pin_15
#define WM8978_DACDAT_AF               GPIO_AF_SPI2
#define WM8978_DACDAT_SOURCE           GPIO_PinSource15
...
void I2Sx_TX_DMA_Init(const uint16_t *buffer0,const uint16_t *buffer1,const uint32_t num,int n);
