...
#define W25X_ReadStatusRegTwo		          0x35 
#define W25X_ReadStatusRegThr		          0x15 
...
extern void SPI_FLASH_BufferRead(u8* pBuffer, u32 ReadAddr, uint32_t NumByteToRead);
...
extern void SPI_Flash_Reset(void);
extern u8 SPI_FLASH_WrInProgStatus(void);
...
extern void W25QXX_Write_SR(u8 sr);
extern u8 W25QXX_ReadSR(u8 StatusReg);
#endif /* __SPI_FLASH_H */
